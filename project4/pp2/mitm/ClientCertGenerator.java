...
public class ClientCertGenerator
{
    ...
    public static final String CERT_ALAIS = "client_cert";

    public ClientCertGenerator(KeyStore ks, String clientKsFileName)
               ...
               UnrecoverableKeyException
    {
        ...
        this.keyStore = ks;
        this.clientKeyStoreFileName = clientKsFileName;
    ...
    private V3Extension createEKU(){
        return new ExtendedKeyUsage(ExtendedKeyUsage.clientAuth);
    }
    ...
    private void updateKeyStore() throws Exception{
        ...
        try {
            fis = new java.io.FileInputStream(this.clientKeyStoreFileName);
            ks.load(fis, ClientCertGenerator.KEY_STORE_PASS.toCharArray());
        } finally {
            if (fis != null) {
                fis.close();
            }
        ...
        ks.setEntry(CERT_ALAIS,
                    newEntry,
                    new KeyStore.PasswordProtection(KEY_STORE_PASS.toCharArray()));

        java.io.FileOutputStream fos = null;
        try {
            fos = new java.io.FileOutputStream(this.clientKeyStoreFileName);
            ks.store(fos, OnTheFlyCertGenerator.KEY_STORE_PASS.toCharArray());
        } finally {
            if (fos != null) {
                fos.close();
            }
    ...
    public static void main(String args[]) throws Exception{
        ...
        KeyStore ks = KeyStore.getInstance(KeyStore.getDefaultType());
        try {
            fis = new java.io.FileInputStream("/Users/jdatko/repos/drexel_cs645/project4/pp2/keystore.jks");
            ks.load(fis, ClientCertGenerator.KEY_STORE_PASS.toCharArray());
        } finally {
            if (fis != null) {
                fis.close();
        ...
        ClientCertGenerator gen = new ClientCertGenerator(ks, "/Users/jdatko/repos/drexel_cs645/project4/pp2/client.jks");

        gen.create("CN=R00t, OU=Software, O=Hax0rwerks, C=US", new BigInteger("42"));
